...
VALUES
    ...
    (
        ...
        'authenticated',
        'authenticated',
        'vincentvendeta+chef1@gmail.com',
...
-- Customer 1
    (
        ...
        'authenticated',
        'authenticated',
        'vincentvendeta+customer1@gmail.com',
        crypt('password123', gen_salt('bf')),
        current_timestamp,
        current_timestamp,
        '{"provider":"email","providers":["email"]}',
  ...
  crypt('password123', gen_salt('bf')),
    ...
    (
        ...
        'authenticated',
        'authenticated',
        'vincentvendeta+admin1@gmail.com',
...
VALUES
    ...
    (
        uuid_generate_v4(),
        chef_western_id,
        format('{"sub":"%s","email":"%s"}', chef_western_id::text, 'vincentvendeta+chef1@gmail.com')::jsonb,
        'email',
    ...
    (
        uuid_generate_v4(),
        customer1_id,
        format('{"sub":"%s","email":"%s"}', customer1_id::text, 'vincentvendeta+customer1@gmail.com')::jsonb,
        'email',
        customer1_id::text,
        current_timestamp,
        current_timestamp,
    ...
    (
        uuid_generate_v4(),
        admin_id,
        format('{"sub":"%s","email":"%s"}', admin_id::text, 'vincentvendeta+admin1@gmail.com')::jsonb,
        'email',
        admin_id::text,
        current_timestamp,
        current_timestamp,
